...
# For numerical data:
        ...
        for i in obj:
            obj[i] = statistics.median([row[i] for row in data[1:]])
...
# For unknow data     
        major_label_test=[]
        for i in range(16):
            majority_labels = [row[i] for row in data if row[i]!= 'unknown']
...
train_input = r"E:\U of U\OneDrive - University of Utah\Course\Machine Learning\bank\bank-4\train.csv"
test_input = r"E:\U of U\OneDrive - University of Utah\Course\Machine Learning\bank\bank-4\test.csv"
max_depth = 16
method = 3# information gain = 1 ; majority error = 2 ; gini index = 3; 
train_out = r"E:\U of U\OneDrive - University of Utah\Course\Machine Learning\bank\bank-4\train_out.txt"
test_out = r"E:\U of U\OneDrive - University of Utah\Course\Machine Learning\bank\bank-4\test_out.txt"
metrics_out = r"E:\U of U\OneDrive - University of Utah\Course\Machine Learning\bank\bank-4\metrics.txt"
